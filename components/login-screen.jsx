      ...
      <div className="relative w-full max-w-md p-5 overflow-hidden bg-white shadow-2xl rounded-3xl sm:p-8">
        ...
        <div className="relative z-10 text-center">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full h-12 text-xl font-bold transition-transform shadow-lg sm:h-14 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:scale-105 shadow-primary/30"
              disabled={isLoading}
            >
              {isLoading ? "登录中..." : "开始冒险！"}
            </Button>
