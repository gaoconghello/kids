...
export const GET = withAuth(["parent", "child"], async (request) => {
  try {
    ...
    const formattedHomeworks = homeworks.map((homework) => ({
      ...
      homework_date: homework.homework_date ? formatDateTime(homework.homework_date, 'YYYY-MM-DD') : null,
      create_review: homework.create_review,
      complete_review: homework.complete_review,
      create_review_time: homework.create_review_time ? formatDateTime(homework.create_review_time) : null,
      complete_review_time: homework.complete_review_time ? formatDateTime(homework.complete_review_time) : null,
      complete_time: homework.complete_time ? formatDateTime(homework.complete_time) : null,
      child_id: homework.child_id,
      created_at: homework.created_at ? formatDateTime(homework.created_at) : null,
      updated_at: homework.updated_at ? formatDateTime(homework.updated_at) : null,
    }));
  ...
  try {
    ...
    const newHomework = await prisma.homework.create({
      data: {
        ...
        homework_date: data.homework_date ? new Date(data.homework_date) : new Date(),
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        deadline: newHomework.deadline ? formatDateTime(newHomework.deadline) : null,
        integral: newHomework.integral || 0,
        incorrect: newHomework.incorrect || 0,
        homework_date: newHomework.homework_date ? formatDateTime(newHomework.homework_date, 'YYYY-MM-DD') : null,
...
export const PUT = withAuth(["parent", "child"], async (request) => {
  try {
    ...
    if (request.user.role === "child" && existingHomework.child_id !== request.user.id) {
      return NextResponse.json(
    ...
    if (request.user.role === "child") {
      ...
      if (data.subject_id !== undefined) updateData.subject_id = data.subject_id ? parseInt(data.subject_id) : null;
      if (data.estimated_duration !== undefined) updateData.estimated_duration = data.estimated_duration ? parseInt(data.estimated_duration) : null;
      if (data.deadline !== undefined) updateData.deadline = data.deadline ? new Date(data.deadline) : null;
      if (data.integral !== undefined) updateData.integral = parseInt(data.integral);
      if (data.incorrect !== undefined) updateData.incorrect = parseInt(data.incorrect);
      if (data.homework_date !== undefined) updateData.homework_date = data.homework_date ? new Date(data.homework_date) : null;
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        deadline: updatedHomework.deadline ? formatDateTime(updatedHomework.deadline) : null,
        integral: updatedHomework.integral || 0,
        incorrect: updatedHomework.incorrect || 0,
        homework_date: updatedHomework.homework_date ? formatDateTime(updatedHomework.homework_date, 'YYYY-MM-DD') : null,
        create_review: updatedHomework.create_review,
        complete_review: updatedHomework.complete_review,
        complete_time: updatedHomework.complete_time ? formatDateTime(updatedHomework.complete_time) : null,
